  ...
  <div class="col-md-12" width="100%" >
    ...
    <div >
      <ul class="nav nav-tabs nav-justified">
		...
		<li class="active"><a href="profile.php">My Audios</a></li>
        ...
        <li><a href="my_gallery.php">My Gallery</a></li>
			...
			<main class="main-content">
			 ...
			 <div class="row">
                ...
                <div class="col-md-8">
				<center><h2 class="page-title">My Audio Library</h2></center>	
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									$query = mysql_query("select * from media where data_type ='.mp3' and banned = '0' and user_id = '$id'");
