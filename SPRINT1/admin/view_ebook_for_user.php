			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					...
					<?php
						...
						$result = mysql_query("SELECT * FROM e_books where banned=0");
						if(!$result){
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  ?>
							<tr>
								...
								<td><a href="../<?=$row['book_path_name'];?>">link book</a></td>		
	<!--							<td>
								...
								<td class="center">
									...
									<a class="btn btn-info" href="ban_book.php?id=<?php echo $row['id']; ?>&id1=<?php echo $person_id; ?>">
										
										<i class="halflings-icon white ban-circle" title="Ban/Active"></i>  
									</a>
									<a class="btn btn-danger" href="delete_book.php?id=<?php echo $row['id']; ?>&id1=<?php echo $person_id; ?>">
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					...
					<?php
						...
						$result = mysql_query("SELECT * FROM e_books where banned=1");
						if(!$result){
						echo "error".mysql_error();
						}
