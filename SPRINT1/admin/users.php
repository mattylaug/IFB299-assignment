	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="users.php"><span>Admin Home</span></a>
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  ?>
							<tr>
								...
								<td><?php echo $row['data_downloaded']; ?></td>
								...
								<td class="center">
									...
									<a class="btn btn-success" href="view_mp3_for_user.php?id=<?php echo $id; ?>">
										<i class="halflings-icon white music" title="View Audios"></i>  
									</a>
									<a class="btn btn-success" href="view_video_for_user.php?id=<?php echo $id; ?>">
										<i class="halflings-icon white facetime-video" title="View Videos"></i>  
									</a>
									<a class="btn btn-success" href="view_ebook_for_user.php?id=<?php echo $id; ?>">
										<i class="halflings-icon white book" title="View EBooks"></i>  
									</a>
									<a class="btn btn-success" href="view_images_for_user.php?id=<?php echo $id; ?>">
										<i class="halflings-icon white picture" title="View Images"></i>  
									</a>
									<a class="btn btn-info" href="ban_user.php?id=<?php echo $id; ?>">
										
										<i class="halflings-icon white ban-circle" title="Ban/Active"></i>  
									</a>
									<a class="btn btn-danger" href="delete_user.php?id=<?php echo $id; ?>">
