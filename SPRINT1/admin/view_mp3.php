			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					...
					<?php
						...
						$result = mysql_query("SELECT * FROM media where banned=0 AND data_type='.mp3'");
						if(!$result){
						  ...
						  ?>
							<tr>
								...
								<td class="center">
									...
									<a class="btn btn-info" href="ban_media_without_user.php?id=<?php echo $row['media_id']; ?>&page=mp3">
										
										<i class="halflings-icon white ban-circle" title="Ban/Active"></i>  
									</a>
									<a class="btn btn-danger" href="delete_media_without_user.php?id=<?php echo $row['media_id']; ?>&page=mp3">
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					...
					<?php
						...
						$result = mysql_query("SELECT * FROM media where banned=1 AND data_type='.mp3'");
						if(!$result){
						echo "error".mysql_error();
						}
