						...
						<div class="col-md-3">
							...
							<div class="col-md-6">
								<form  name="frmRegistration" action="" method="post" class="contact-form">
									...
									<input type="checkbox" name="terms"  style="float:left;"><p style="margin-top:-1.4%; margin-left:5%;">I accept the terms of services and <a href="poliy.html" style="color:#fd5927; text-decoration:none;">privacy policy</a></p>
