						...
						<div class="row">
							...
							<div class="col-md-6">
								<form  name="frmRegistration" action="" method="post" class="contact-form">
									...
									<input type="checkbox" name="terms"  style="float:left;"><p style="margin-top:-1.4%; margin-left:5%;">I accept the terms of services and <a title="Privcy Policy. This link will open in a new window." 
										onclick="window.open('policy.html', '_blank', 'status=yes, location=no, 
										menubar=no, resizable=yes, scrollbars=yes, toolbar=no, width=635, height=545, 
										screenX=0, left=0, screenY=0, top=0'; return false;" 
									target="_blank" href="policy.html">privacy policy</a></p>
