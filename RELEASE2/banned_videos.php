	...
	<body>
		...
		<div id="site-content" >
				...
				<div class="col-md-12" width="100%" >
					...
					<div >
						<ul class="nav nav-tabs nav-justified">
							...
							<li  class="active"><a href="banned_videos.php">Banned Videos</a></li>
			...
			<div class="row">
                ...
                <div class="col-md-8">
					<center><h2 class="page-title">Banned Videos</h2></center>	
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
										<?php
											...
											$query = mysql_query("select * from media where banned = '1' and user_id = '$id' and (data_type ='.mp4' || data_type ='.wma' || data_type ='.avi') ");
