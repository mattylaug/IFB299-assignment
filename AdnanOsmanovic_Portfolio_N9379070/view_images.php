...
<body>
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="index.html"><span>Admin Home</span></a>
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					...
					<?php
						...
						$result = mysql_query("SELECT * FROM media where banned=0 AND (data_type='.png' || data_type='.jpg' || data_type='.bmp')");
						if(!$result){
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  $result1= mysql_query("SELECT first_name FROM registered_users where user_id=$person_id;");
						  ...
						  ?>
							<tr>
								...
								<td class="center">
									...
									<a class="btn btn-info" href="ban_media_without_user.php?id=<?php echo $row['media_id']; ?>&page=image">
										
										<i class="halflings-icon white ban-circle" title="Ban/Active"></i>  
									</a>
									<a class="btn btn-danger" href="delete_media_without_user.php?id=<?php echo $row['media_id']; ?>&page=image">
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					...
					<?php
						...
						$result = mysql_query("SELECT * FROM media where banned=1 AND (data_type='.png' || data_type='.jpg' || data_type='.bmp')");
						if(!$result){
						echo "error".mysql_error();
						}
	...
	<div class="modal hide fade" id="myModal">
		...
		<div class="modal-body">Here settings can be configured...</p>
		</div>
