  ...
  <div class="col-md-12" width="100%" >
    ...
    <div >
      <ul class="nav nav-tabs nav-justified">
        ...
        <li class="active"><a href="my_videos.php">My Videos</a></li>
        <li><a href="banned_videos.php">Banned Videos</a></li>
		<li><a href="my_ebooks.php">My Ebooks</a></li>
        <li><a href="my_gallery">My Gallery</a></li>
			...
			<main class="main-content">
			   ...
			   <div class="row">
                ...
                <div class="col-md-8">
				<center><h2 class="page-title">My Videos Library</h2></center>	
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									$query = mysql_query("select * from media where banned = '0' and user_id = '$id' and (data_type ='.mp4' || data_type ='.wma' || data_type ='.avi') ");
